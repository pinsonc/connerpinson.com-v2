...
import { FaLinkedin, FaGithub, FaTwitter, FaYoutube, FaEnvelope, FaMastodon, FaKeybase } from 'react-icons/fa'
  ...
  >
    ...
    >
      ...
      <div style={{paddingTop: `1.0875rem`}}>
        ...
        <a style={{color: 'white', textDecoration: 'none', paddingLeft: '10px'}} target="_blank" rel="me noreferrer" aria-label="Mastodon" href="https://mstdn.social/@pinsoneedles"><FaMastodon/></a>
        <a style={{color: 'white', textDecoration: 'none', paddingLeft: '10px'}} target="_blank" rel="noreferrer" aria-label="Keybase" href='https://keybase.io/pinsoneedles'><FaKeybase /></a>
